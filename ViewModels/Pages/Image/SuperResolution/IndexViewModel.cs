...
namespace General.Apt.App.ViewModels.Pages.Image.SuperResolution
{
    public partial class IndexViewModel : ObservableValidator, INavigationAware
    {
        ...
        public async Task Start()
        {
            try
            {
                ...
                if (!Vulkan.IsSupport()) throw new Exception(Language.GetString("ImageSuperResolutionIndexPageNotSupportVulkan"));
