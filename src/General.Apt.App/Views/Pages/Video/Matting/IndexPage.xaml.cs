using General.Apt.App.ViewModels.Pages.Video.Matting;
using Wpf.Ui.Controls;

namespace General.Apt.App.Views.Pages.Video.Matting
{
    public partial class IndexPage : INavigableView<IndexViewModel>
    {
        ...
        public async Task InitializeData()
        {
            ...
            await Utility.Message.AddTextInfo(Service.Utility.Language.Instance["VideoMattingHelp"], ViewModel.MessageAction);
        }
    }
}
