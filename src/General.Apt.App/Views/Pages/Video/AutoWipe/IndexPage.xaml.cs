using General.Apt.App.ViewModels.Pages.Video.AutoWipe;
using Microsoft.Win32;
using System.IO;
using System.Windows.Media.Imaging;
using Wpf.Ui.Controls;

namespace General.Apt.App.Views.Pages.Video.AutoWipe
{
    public partial class IndexPage : INavigableView<IndexViewModel>
    {
        ...
        public async Task InitializeMask()
        {
            ...
            ViewModel.MaskAction += () =>
            {
                ...
                {
                    //context.DrawVideo(maskSource, new Rect(0, 0, maskSource.Width, maskSource.Height));
