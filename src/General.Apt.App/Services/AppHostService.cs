...
namespace General.Apt.App.Services
{
    public class AppHostService : IHostedService
    {
        ...
        public static void GetConfig()
        {
            ...
            var imageMattingViewModel = App.Current.GetService<ViewModels.Pages.Image.Matting.IndexViewModel>();
            ...
            var videoMattingViewModel = App.Current.GetService<ViewModels.Pages.Video.Matting.IndexViewModel>();
