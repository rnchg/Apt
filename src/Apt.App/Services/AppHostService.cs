...
namespace Apt.App.Services
{
    public class AppHostService : IHostedService
    {
        ...
        {
            var imageSuperResolutionViewModel = App.Current.GetRequiredService<ViewModels.Pages.Image.SuperResolution.IndexViewModel>();
            ...
            var imageAutoWipeViewModel = App.Current.GetRequiredService<ViewModels.Pages.Image.AutoWipe.IndexViewModel>();
            ...
            var imageCartoonComicViewModel = App.Current.GetRequiredService<ViewModels.Pages.Image.CartoonComic.IndexViewModel>();
            ...
            var imageConvert3dViewModel = App.Current.GetRequiredService<ViewModels.Pages.Image.Convert3d.IndexViewModel>();
            ...
            var imageColorRestorationViewModel = App.Current.GetRequiredService<ViewModels.Pages.Image.ColorRestoration.IndexViewModel>();
            ...
            var imageFrameInterpolationViewModel = App.Current.GetRequiredService<ViewModels.Pages.Image.FrameInterpolation.IndexViewModel>();
            ...
            var imageMattingViewModel = App.Current.GetRequiredService<ViewModels.Pages.Image.Matting.IndexViewModel>();
            ...
            imageMattingViewModel.InputSort = Current.Config.ImageMatting.InputSort;
            imageMattingViewModel.SortRule = Current.Config.ImageMatting.SortRule;
            ...
            var imageFaceRestorationViewModel = App.Current.GetRequiredService<ViewModels.Pages.Image.FaceRestoration.IndexViewModel>();
            ...
            var videoSuperResolutionViewModel = App.Current.GetRequiredService<ViewModels.Pages.Video.SuperResolution.IndexViewModel>();
            ...
            //var videoAutoWipeViewModel = App.Current.GetRequiredService<ViewModels.Pages.Video.AutoWipe.IndexViewModel>();
            ...
            var videoCartoonComicViewModel = App.Current.GetRequiredService<ViewModels.Pages.Video.CartoonComic.IndexViewModel>();
            ...
            var videoConvert3dViewModel = App.Current.GetRequiredService<ViewModels.Pages.Video.Convert3d.IndexViewModel>();
            ...
            var videoColorRestorationViewModel = App.Current.GetRequiredService<ViewModels.Pages.Video.ColorRestoration.IndexViewModel>();
            ...
            var videoFrameInterpolationViewModel = App.Current.GetRequiredService<ViewModels.Pages.Video.FrameInterpolation.IndexViewModel>();
            ...
            var videoMattingViewModel = App.Current.GetRequiredService<ViewModels.Pages.Video.Matting.IndexViewModel>();
            ...
            videoMattingViewModel.InputSort = Current.Config.VideoMatting.InputSort;
            videoMattingViewModel.SortRule = Current.Config.VideoMatting.SortRule;
            ...
            var videoOrganizationIndexViewMode = App.Current.GetRequiredService<ViewModels.Pages.Video.Organization.IndexViewModel>();
        ...
        public static void SetConfig()
        {
            ...
            Current.Config.ImageMatting.InputSort = imageMattingViewModel.InputSort;
            Current.Config.ImageMatting.SortRule = imageMattingViewModel.SortRule;
            ...
            Current.Config.VideoMatting.InputSort = videoMattingViewModel.InputSort;
            Current.Config.VideoMatting.SortRule = videoMattingViewModel.SortRule;
