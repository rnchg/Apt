using General.Apt.App.ViewModels.Pages.Image.SuperResolution;
using Wpf.Ui.Controls;

namespace General.Apt.App.Views.Pages.Image.SuperResolution
{
    /// <summary>
    ...
    public partial class IndexPage : INavigableView<IndexViewModel>
    {
        ...
        public async Task InitializeData()
        {
            ...
            await Utility.Message.AddTextInfo(Service.Utility.Language.GetString("ImageSuperResolutionHelp"), ViewModel.MessageAction);
        }
    }
}
