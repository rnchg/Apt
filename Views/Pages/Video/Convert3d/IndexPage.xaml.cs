using General.Apt.App.ViewModels.Pages.Video.Convert3d;
using Wpf.Ui.Controls;

namespace General.Apt.App.Views.Pages.Video.Convert3d
{
    /// <summary>
    ...
    public partial class IndexPage : INavigableView<IndexViewModel>
    {
        ...
        public async Task InitializeData()
        {
            ...
            await Utility.Message.AddTextInfo(Service.Utility.Language.GetString("VideoConvert3dHelp"), ViewModel.MessageAction);
        }
    }
}
