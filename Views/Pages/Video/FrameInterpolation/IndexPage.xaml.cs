using General.Apt.App.ViewModels.Pages.Video.FrameInterpolation;
using Wpf.Ui.Controls;

namespace General.Apt.App.Views.Pages.Video.FrameInterpolation
{
    /// <summary>
    ...
    public partial class IndexPage : INavigableView<IndexViewModel>
    {
        ...
        public async Task InitializeData()
        {
            ...
            await Utility.Message.AddTextInfo(Service.Utility.Language.GetString("VideoFrameInterpolationHelp"), ViewModel.MessageAction);
        }
    }
}
